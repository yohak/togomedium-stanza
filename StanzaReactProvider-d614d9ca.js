import { g as getDefaultExportFromCjs, S as Stanza, _ as __awaiter } from './stanza-97f45b0e.js';
import { r as reactExports, h as hasOwn, E as Emotion$1, a as createEmotionProps, c as css, G as Global, T as ThemeContext$2, R as React, C as CacheProvider, b as createCache } from './getData-8b0d864a.js';
...
const StanzaReactProvider = ({ children }) => {
    return (jsx(reactExports.StrictMode, { children: jsx(QueryClientProvider, { client: queryClient, children: jsx(Recoil_index_5, { children: jsx(ThemeProvider, { theme: muiTheme, children: jsx(EmotionCacheProvider, { children: children }) }) }) }) }));
};
...
class TogoMediumReactStanza extends Stanza {
    constructor() {
        super(...arguments);
        this.reactElm = this.root.querySelector("main");
        this.reactRoot = createRoot(this.reactElm);
    }
    render() {
...
export { createTheme as $, useRtl as A, capitalize as B, COLOR_PRIMARY as C, alpha as D, resolveProps as E, Fragment as F, COLOR_GRAY_BG as G, SIZE1 as H, ROUNDED_CORNER as I, SIZE2 as J, SIZE05 as K, FONT_WEIGHT_MEDIUM as L, COLOR_GRAY_LINE as M, FONT_WEIGHT_BOLD as N, SIZE3 as O, COLOR_GRAY700 as P, SIZE4 as Q, Recoil_index_8 as R, Subscribable as S, TogoMediumReactStanza as T, GlobalStyles as U, defaultSxConfig$1 as V, isPlainObject as W, getOverlayAlpha as X, formatMuiErrorMessage as Y, deepmerge as Z, styleFunctionSx$1 as _, jsxs as a, useDefaultProps as a0, clamp as a1, lighten as a2, darken as a3, COLOR_GRAY400 as a4, COLOR_GRAY as a5, FONT_EN as a6, Recoil_index_9 as a7, COLOR_GRAY500 as a8, COLOR_ACCENT as a9, resolveStaleTime as b, isValidTimeout as c, fetchState as d, replaceData as e, focusManager as f, notifyManager as g, COLOR_GRAY300 as h, isServer as i, jsx as j, COLOR_PRIMARY_DARK as k, COLOR_WHITE as l, COLOR_TEXT as m, noop as n, Recoil_index_20 as o, Recoil_index_24 as p, createTheme$1 as q, resolveEnabled as r, shallowEqualObjects as s, timeUntilStale as t, useQueryClient as u, useTheme$1 as v, THEME_ID as w, ReactDOM as x, reactDomExports as y, jsxRuntimeExports as z };
//# sourceMappingURL=StanzaReactProvider-d614d9ca.js.map

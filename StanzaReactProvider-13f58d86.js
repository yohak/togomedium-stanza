import { o as objectAssign, g as getDefaultExportFromCjs, S as Stanza, _ as __awaiter } from './stanza-be82c2ee.js';
import { r as reactExports, h as hasOwnProperty, E as Emotion$1, a as createEmotionProps, c as css, _ as _extends, T as ThemeContext$2, R as React, G as Global, C as CacheProvider, b as createCache } from './getData-e69d262f.js';
...
const StanzaReactProvider = ({ children }) => {
    return (jsx(reactExports.StrictMode, { children: jsx(Recoil_index_4, { children: jsx(ThemeProvider, { theme: muiTheme, children: jsx(EmotionCacheProvider, { children: children }) }) }) }));
};
...
class TogoMediumReactStanza extends Stanza {
    ...
    _render() {
        ...
        ReactDOM.render(jsx(StanzaReactProvider, { children: children }), main);
    }
}

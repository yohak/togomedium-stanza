import { o as objectAssign } from './stanza-f44e302d.js';
  ...
  return (tag, inputOptions = {}) => {
    const {
      ...
      overridesResolver
          ...
          options = _objectWithoutPropertiesLoose(inputOptions, _excluded$4); // if skipVariantsResolver option is defined, take the value, otherwise, true for root and false for other slots.
...
const FONT_EN = "'Fira Sans', sans-serif";

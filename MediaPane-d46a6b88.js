...
const MediaPane = ({ css, className, dispatchEvent, next, prev }) => {
    ...
    return (jsxs("div", { css: wrapper, children: [jsxs("div", { css: [media, css], className: className, children: [jsx(MediaTab, {}), jsxs("div", { css: contents, children: [tabFocus === "Found media" && jsx(FoundMediaList, { next: next, prev: prev }), tabFocus === "Selected media" && jsx(SelectedMediaList, {})] })] }), tabFocus === "Selected media" && (jsx(ActionPane, { actionLabel: "Compare media", dispatchEvent: dispatchEvent }))] }));
};
const useTabFocus = () => {
    const tabFocus = useMediaTabFocusState();
    const { setMediaTabFocus } = useMediaTabFocusMutators();
